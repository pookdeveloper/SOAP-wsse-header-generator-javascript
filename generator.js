function calc() {
  ...
  var nonce64 = btoa(nonce);
  var created = "";
  var autoCreated = true;
  ...
  var basicUsername = pm.globals.get("usu");
  var basicPassword = pm.globals.get("pass");
  var basicAuth = "";

  if (basicUsername != null && basicUsername != "" ||
    basicPassword != null && basicPassword != "") {
    basicAuth = "Authorization: Basic " + btoa(basicUsername + ":" + basicPassword) + "\n";
  }
  ...
  console.log("Result of the variable nonce64 --> " + nonce64);
  console.log("Result of the variable created --> " + created);
  console.log("Result of the variable passwordDigest --> " + passwordDigest);
